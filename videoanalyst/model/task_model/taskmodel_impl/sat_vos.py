...
class SatVOS(ModuleBase):
    ...
    def forward(self, *args, phase="train"):
        ...
        # phase: feature
            ...
            # 关键在于corr_feature的尺寸参数，shape=[1, 256, 17, 17]，这里还要论述添加互相关特征corr_feature的必要性，需通过实验来确定！！！
            enc_features = self.joint_encoder(saliency_image, corr_feature)
            decoder_features = [global_feature] + enc_features # [(512, 5, 5), (512, 9 ,9), (256, 17, 17), (128, 33, 33), (64, 66, 66)]
